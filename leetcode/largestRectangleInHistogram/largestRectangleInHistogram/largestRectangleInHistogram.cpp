...
// 4) How do we get left and right indexes of the popped bar ¨C 
...
int largestRectangleArea(vector<int>&height)
{
	...
	vector<int>stack;
	//add a flag as a trigger if the end bar is me , and need to check the stack is empty of not ;
	height.push_back(0);
	int maxArea = 0;
	for (int i = 0; i < height.size(); i++)
	{
		//if stack is empty or height [i ] is higher than the bar at top of stack ,then push 'i	' ,then push ' i' to stack ;
