...
private:
	...
	Stack <minData> minStack;//miniaml number stack store the number ;
...
public:
	void push(int x)
	{
		...
		else
		{
			...
			{
				min = x; 
				//if current  minial number already pushed ,the add the refence count
	...
	void pop() {
		...
		{
			//de-reference the count at first.v
